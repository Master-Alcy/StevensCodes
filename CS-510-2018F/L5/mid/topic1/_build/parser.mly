...
expr:
    ...
    | REPLACE; LPAREN; e1 = expr; COMMA; e2 = expr; COMMA; e3 = expr; RPAREN { Replace(e1,e2,e3) }
    | REPETITION; LPAREN; e1 = expr; COMMA; e2 = expr; RPAREN { Repetition(e1, e2) }
    | REMOVEDUP; LPAREN; e = expr; RPAREN { Remove_dup(e) }
    | INTERSECTION; LPAREN; e1 = expr; COMMA; e2 = expr; RPAREN { Intersection(e1, e2) }
