...
expr:
    ...
    | UNTUPLE; LPAREN; ids = ids_comma; RPAREN; EQUALS; 
      e1 = expr; IN; e2 = expr { LetTuple(ids,e1,e2) }
    | CONS; LPAREN; e1 = expr; COMMA; e2 = expr; RPAREN { Cons(e1, e2) }
    | CONST; LPAREN; e1 = expr; COMMA; e2 = expr; RPAREN { ConsT(e1, e2) }
    | APPEND; LPAREN; e1 = expr; COMMA; e2 = expr; RPAREN { Append(e1, e2) }
    | APPENDT; LPAREN; e1 = expr; COMMA; e2 = expr; RPAREN { AppendT(e1, e2) }
    | INSR; LPAREN; e1 = expr; COMMA; e2 = expr; COMMA; e3 = expr; RPAREN { Insr(e1, e2, e3) }
    | SUBLIST; LPAREN; e1 = expr; COMMA; e2 = expr; COMMA; e3 = expr; RPAREN { Sublist(e1, e2, e3) }
    | REMV; LPAREN; e1 = expr; COMMA; e2 = expr; RPAREN { Remv(e1, e2) }
    | COUNT; LPAREN; e1 = expr; COMMA; e2 = expr; RPAREN { Count(e1, e2) }
    ...
    | REMOVEDUP; LPAREN; e = expr; RPAREN { Remove_dup(e) }
    | UNION; LPAREN; e1 = expr; COMMA; e2 = expr; RPAREN { Union(e1, e2) }
