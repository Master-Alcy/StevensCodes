...
git s
git branch
git --d testWorkFlow.txt
git branch --d testWorkFlow.txt
git branch --D testWorkFlow.txt
git branch -D testWorkFlow.txt
branch
git branch
...
cd L5
ls
mv test.html /c/Users/aijin/github
$home
$HOME
cd $HOME
cd ..
ls
mv test.html git/StevensCodes/CS-546-2018F
cd git
cd StevensCodes
cd CS-546-2018F
ls
...
git add .
git s
git ca "Created index.html file"
git log
git s
git commit
git add .
git s
git ca "Added skeleton of content up for coffee description"
git branch
git push origin coffee
git s
git add .
git ca "Add two lists"
git push origin coffee
git s
git add .
git ca "add table"
...
git s
git add .
git ca "Moved content to Lecture 5 folder"
...
git add .
git s
git ca "For web programming"
git push
clear
ls
cd StevensCodes/CS-546-2018F/lab5
touch README.md
git init
git branch
git branch
...
cd FinalProject/
ls
echo "# Library_System" >> README.md
git init
git add README.md
git ca "first commit"
git remote add origin git@github.com:CS546-Team/Library_System.git
